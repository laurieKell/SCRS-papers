...
trendPhaseMar2(window(mvln[["stock"]],end=2022),ylim=3, ylab=expression(SSB:B[MSY]))
```
...
trendPhaseMar2(window(mvln[["harvest"]],end=2022),ylim=2,
...
trendPhaseMar2(window(mvln[["stock"]],start=2000, end=2070),ylim=3, 
...
trendPhaseMar2(window(mvln[["harvest"]],start=2000, end=2070),ylim=2, 
               ylab=expression(F:F[MSY]))
```
